...
import { middleFingerGesture } from "./custom";
...
import finger_splayed from "./finger_splayed.png";
import raised_hand from "./raised_hand.png"
import pinching from "./pinching.png"
import ok from "./ok.png"
import fist from "./fist.png"
import middle_finger from "./middle_finger.png"
  ...
  const detect = async (net) => {
    ...
    if (
      ...
      if (hand.length > 0) {
        ...
        const gesture = await GE.estimate(hand[0].landmarks, 5.5);
